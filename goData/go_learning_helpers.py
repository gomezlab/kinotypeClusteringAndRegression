...
def get_tts(dat, test_size=0.2, random_state=None):
    ...
    X_train, X_test, y_train, y_test = tts(dat['GO Labels'], dat['cluster'], test_size=test_size, random_state=random_state)
