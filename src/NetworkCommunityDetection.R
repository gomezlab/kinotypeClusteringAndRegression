...
write.table(compiled.votes, '/Users/lutzka/Dropbox/Analyses/DrugComboMethod/Results/consensusclusters_spinglass_greaterthan90percent.txt',quote=FALSE,sep="\t",row.names=FALSE)
write.table(fggroups, '/Users/lutzka/Dropbox/Analyses/DrugComboMethod/Results/fastgreedy_clusters.txt',quote=FALSE,sep="\t",row.names=FALSE)
...
write.table(lec.compiled.votes, '/Users/lutzka/Dropbox/Analyses/DrugComboMethod/Results/consensusclusters_leadingeigenvector_greaterthan90percent.txt',quote=FALSE,sep="\t",row.names=FALSE)
